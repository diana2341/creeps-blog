        ...
        <div v-for="story in stories" class="story">
            <div class="story-inner-card">
                ...
                <div  class="card-right">
                    <div class="stars">
                        <span v-for="star in renderStars(story.rating).full"><i class="fa-solid fa-star"></i></span>
                        <span v-for="star in renderStars(story.rating).half"><i class="fa-solid fa-star-half-stroke"></i></span>
                        <span v-for="star in renderStars(story.rating).empty"><i class="fa-regular fa-star"></i></span>
                     </div>
                    <span class="story-title">{{ story.title }}</span>
                    <span class="story-text">{{ story.story.substring(0,250) + "..." }}</span>
                    <div class="metadata">
                    ...
                    <div><i class="fa-solid fa-comments"></i> {{ story.comments.length }} Comments</div>
                    ...
                    <div class="metadata">
                        ...
                        <span class="author"><i class="fa-solid fa-feather"></i> {{ story.author }}</span>
                        <span
...
onMounted(async () => {
  ...
  // Fetch stories from the store

  // Access the stories from the store
});
